    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                <form class="max-w-md" action="{{ route('repositories.update', $repository) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <input class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md" type="submit" value="Editar">
                </form>
            </div>
        </div>
    </div>
